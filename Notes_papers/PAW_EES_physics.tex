...
\begin{table}[!htbp]
\caption{\label{index} Largest $\beta_{\mathrm{universal}}$ for each grid size to achieve the desired tolerance per atom in $E_{\rH}^{(\rcomp,\mathrm{screen, self, grid})}$.}
\begin{center}
\begin{tabular}{ c  c  c  c}
  \hline\hline
...
\begin{figure}[!htbp] 
    ...
    \caption{Percent error versus $\beta_{\mathrm{universal}}$ for different radial grid sizes.} 
    \label{fig:error}
\end{figure}
...
\begin{figure}[!htbp] 
    ...
    \caption{For $n_r = 14$, the percentage difference between the screened and unscreened Hartree self energy term versus $\beta_{\mathrm{universal}}$. The asymptotic regime is reached for $\beta_{\mathrm{universal}} > 2$.} 
    \label{fig:diffbeta}
\end{figure}
...
\begin{figure}[!htbp] 
    ...
    \caption{Percentage error versus $n_r$ for different $\beta_{\mathrm{universal}}$ on a semilog plot.} 
    \label{fig:diffbeta}
\end{figure}
...
\begin{figure}[!htbp] 
    ...
    \caption{Percentage error versus $n_r$ for different $\beta_{\mathrm{universal}}$ on a loglog plot.} 
    \label{fig:diffbeta}
\end{figure}
